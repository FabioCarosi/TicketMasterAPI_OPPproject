...
public class Filters {
	...
	public JSONArray filtersImplementation() throws WrongPeriodException, WrongParameterException,WrongValueException, WrongComparatorException{
		...
		if (comparator.equals("country")) {
			if (period == 1) {
				if (parameter.equals("marketID")) {
					...
					throw new WrongParameterException(parameter + " non è accettato. Scegli tra: marketID, source, segment, genre e subgenre.");
			} else if (period == 3) {
				...
				if (parameter.equals("marketID")) {
					...
					throw new WrongParameterException(
							parameter + " non è accettato. Scegli tra: marketID, source, segment, genre e subgenre.");
			} else if (period == 6) {
			...
			else throw new WrongParameterException (parameter + " non è un parameteretro ammesso. Puoi inserire solo la stringa country.");		
	    }     
			else if(period == 3) {
		...
		else throw new WrongParameterException (parameter + " non è un parametro ammesso. Puoi inserire solo la stringa country.");
    }
	...
	else throw new WrongComparatorException(comparator + " non è una stringa ammessa. Inserisci una stringa tra "
