...
public class SourceFilter {
	...
	public JSONArray period(Vector<String> states, String source, int period) throws WrongStateException, WrongValueException {
		...
		sourceEvents.put(maxStateEvents);	//Inserisco il JSONOBject dellos stati con più eventi all'interno del JSONArray finale
		sourceEvents.put(minStateEvents);	//Inserisco il JSONOBject dellos stati con meno eventi all'interno del JSONArray finale
